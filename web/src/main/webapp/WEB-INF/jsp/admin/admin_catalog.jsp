...
<a href="${pageContext.request.contextPath}/admin/catalog/add">Add</a><br>
<br>
<p>${categoryName}</p>

<c:forEach items="${categories}" var="category">
    <a name="id" href="${pageContext.request.contextPath}/admin/catalog?name=${category.category}"><c:out
            value="${category.category}"/></a>
</c:forEach>
<a name="id" href="${pageContext.request.contextPath}/admin/catalog?name=all">All</a><br>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:forEach items="${listGoods}" var="goods">
                ...
                <a href="${pageContext.request.contextPath}/admin/catalog/update?id=${goods.id}">Update</a><br>
                <br>
            </c:forEach>
        </c:otherwise>
    </c:choose>
