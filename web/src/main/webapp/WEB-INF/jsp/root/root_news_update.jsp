...
<a href="${pageContext.request.contextPath}/root/news/selected?id=${news.id}">Return</a><br>
<form action="${pageContext.request.contextPath}/root/news/update" method="post" enctype="multipart/form-data">
