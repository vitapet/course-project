...
<br>
<p>Новости</p>
<a href="${pageContext.request.contextPath}/root/news/add">Add</a><br>
<form action="${pageContext.request.contextPath}/root/news" method="post">
    <c:choose>
        ...
        <c:otherwise>
            <c:forEach items="${newsList}" var="news">
                ...
                <a href="${pageContext.request.contextPath}/root/news/selected?id=${news.id}">Подробнее</a><br>
                <br>
            </c:forEach>
        </c:otherwise>
    </c:choose>
